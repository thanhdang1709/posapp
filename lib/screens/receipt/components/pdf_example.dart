...
Future<Uint8List> generateInvoice(PdfPageFormat pageFormat) async {
  ...
  final invoice = Invoice(
    ...
    products: products,
    customerName: 'Khach Vip',
    customerAddress: '174 Khuong Viet, P.Phu Trung, Q. Tan Phu',
    paymentInfo: '174 Khuong Viet, P.Phu Trung, Q. Tan Phu',
    tax: .15,
      ...
      children: [
        pw.Expanded(
          child: pw.Container(
            ...
            child: pw.FittedBox(
              child: pw.Text(
                'Tong: ${_formatCurrency(_grandTotal)}',
                style: pw.TextStyle(
                  color: baseColor,
...
String _formatCurrency(double amount) {
  return '${$Number.numberFormat(int.parse(amount.toStringAsFixed(0)))} d';
}

String _formatDate(DateTime date) {
  final format = DateFormat('h:m d-M-y');
