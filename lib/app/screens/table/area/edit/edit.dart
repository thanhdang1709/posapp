...
class EditAreaScreen extends GetView<TableController> {
  //CustomerController customerController = Get.put(CustomerController());

  @override
  Widget build(BuildContext context) {
    TableController controller = Get.put(TableController());
    controller.nameAreaController.text = controller.selectedArea.name;
    controller.descriptionAreaController.text = controller.selectedArea.description;
    return Scaffold(
      appBar: AppUltils.buildAppBar(
        height: CONTANTS.HEIGHT_APPBAR,
        title: 'Sửa khu vực'.tr,
      ),
      body: Column(
        children: [
          SizedBox(
          ...
          Obx(() => Padding(
              ...
              child: MyButtonSubmit(
                ...
                onPressed: controller.isDisableSubmit.value ? null : controller.onUpdateArea,
              )))
        ],
      ),
    );
