...
class ConfirmTableItem extends StatefulWidget {
  ...
  @override
  _ConfirmTableItemState createState() => _ConfirmTableItemState();
}

class _ConfirmTableItemState extends State<ConfirmTableItem> with SingleTickerProviderStateMixin {
  double _scale;
